...
function Achievements() {
    const data=[
        {img:image1,text:"Hexnode is listed as a leader and a major player in IDC MarketScape UEM Vendors Assessment Reports 2024."},
        {img:image2,text:"Hexnode was recognized in the 2025 Gartner® Market Guide for Unified Endpoint Management Tools."},
        {img:image3, text:"Forrester includes Hexnode as a Notable vendor in The Unified Endpoint Management Landscape, Q3 2023."},
    ]
  ...
  {data.map((item, index) => (
   ...
   className={`md:my-10 md:px-6 lg:px-10 flex flex-col items-center ${
     index !== data.length - 1 ? "md:border-r-[1px] md:border-[rgb(255,255,255,60%)]" : ""
   }`}
 >
